...
$I->wantTo('Play Web Finsoft - Cleopatra');
...
//Find a game
$I->fillField('#searchGames input','Cleopatra');
$I->waitForElementVisible('.gamesFilteredDisplay [alt=Cleopatra]',30);
$I->wait(1);
$I->click('.gamesFilteredDisplay [alt=Cleopatra]');
...
$sftp->put('cleopatra.au3','tests/acceptance/AutoIt/scripts/cleopatra.au3',NET_SFTP_LOCAL_FILE);


//execute AutoIt script
$ssh->exec('C:\Selenium\AutoIT3\AutoIt3.exe C:\Selenium\AutoIT\cleopatra.au3');
...
$I->clickXY('#iframegamecontainer',285,435); //Click on Resume Game in case previous round not finished
$I->wait(1);
$I->clickXY('#iframegamecontainer',375,400); //Click on OK in case previous round not finished
$I->wait(10);
$I->clickXY('#iframegamecontainer',352,674); //Click Minumum Coin Value
$I->wait(1);
$I->clickXY('#iframegamecontainer',352,674); //Click Minumum Coin Value
$I->wait(1);
$I->clickXY('#iframegamecontainer',352,674); //Click Minumum Coin Value
$I->wait(1);
$I->clickXY('#iframegamecontainer',666,674); //Click on Spin
$I->wait(15);
...
$stake=20; // Starburst Stake in cents
...
if(!$won){ //If not won first record will be a debit one and no credit
	...
	if (strpos($trans, 'Cleopatra, bet:') === false){
	...
	$debit=$I->grabTextFrom('.statement-history tr:nth-of-type(1) td:nth-of-type(4)');
	$credit=$I->grabTextFrom('.statement-history tr:nth-of-type(1) td:nth-of-type(5)');
	$I->amGoingTo('Credit record data:'.$datetime.' - '.$trans.' - '.$debit.' - '.$credit);
