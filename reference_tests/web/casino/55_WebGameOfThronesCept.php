...
$I->wantTo('Play Web QuickFire - Game Of Thrones');
...
start:
//As Landing page is diferent than rest of the web we need to contrl Iteration before calling Casino.
if($iteration>=1){
...
//Find a game
$I->fillField('#searchGames input','game of thrones');
$I->waitForElementVisible('.gamesFilteredDisplay [src$="GC_QFC-game-of-thrones_243Ways.jpg"]',30);
$I->wait(1);
$I->click('.gamesFilteredDisplay [src$="GC_QFC-game-of-thrones_243Ways.jpg"]');
...
$sftp->put('gameofthrones.au3','tests/acceptance/AutoIt/scripts/gameofthrones.au3',NET_SFTP_LOCAL_FILE);


//execute AutoIt script
$ssh->exec('C:\Selenium\AutoIT3\AutoIt3.exe C:\Selenium\AutoIT\gameofthrones.au3');
*/

//Play the Game

$I->waitForElement('#iframegamecontainer',30);
$I->clickXY('#iframegamecontainer',178,264); //Click on Bonus Position
$I->wait(5);
$I->clickXY('#iframegamecontainer',508,524); //Click Continue Position
$I->wait(1);
$I->clickXY('#iframegamecontainer',768,532); //Click on Spin
$I->wait(15);
...
$stake=30; // Starburst Stake in cents
...
if(!$won){ //If not won first record will be a debit one and no credit
	...
	if(strcmp($trans, "Quick Fire Casino Stake tx")!== 0){
			...
			try{
				...
				try{
					...
					if($iteration>=1){
						...
						$I->redText("Failed: Game was not played. Starint Iteration 2");
						$I->click('.main-logo a');
						$I->wait(2);
						$iteration=1;
						goto start;
	...
	if(strcmp($trans, "Quick Fire Casino Return tx")!== 0){
