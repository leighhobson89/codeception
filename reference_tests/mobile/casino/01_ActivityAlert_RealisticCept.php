...
$I->wantTo('verify Activity Alert - Realistic - Black Jack');
...
$I->waitForElementVisible('body > iframe',30); 

// Switch to iFrame
$I->executeJS('document.querySelector("body > iframe").setAttribute("id","realisticIframe")'); //Setting temporary name attribute for Activity Alert iFrame
$I->switchToIFrame("realisticIframe"); // Swithching to Activity Alert iframe

// Verify the Activity alert
$I->amGoingTo("Verify the Activity alert");
$I->waitForElementVisible('.reality-check-shown',30); // Wait for Activity Alert
$I->waitForElementVisible('#dialogbox h2',30);
